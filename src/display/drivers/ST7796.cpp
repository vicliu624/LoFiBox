...
static const CommandTable_t st7796_init_commands[] = {
    ...
    {0xE0,
     {0xF0, 0x09, 0x0b, 0x06, 0x04, 0x15, 0x2F, 0x54, 0x42, 0x3C, 0x17, 0x14,
      0x18, 0x1B},
     0x0F}, // Positive Voltage Gamma Control
    {0xE1,
     {0xE0, 0x09, 0x0b, 0x06, 0x04, 0x03, 0x2B, 0x43, 0x42, 0x3B, 0x16, 0x14,
      0x17, 0x1B},
     0x8F},               // Negative Voltage Gamma Control
...
const CommandTable_t *ST7796::getInitCommands() { return st7796_init_commands; }
...
ST7796::getRotationConfig(uint16_t width, uint16_t height,
  ...
  // Landscape orientations (90°, 270°): use landscape_offset_x for horizontal
  // offset
  static DispRotationConfig_t rotation_configs[4];

  // Portrait 0° (rotated): width=height, height=width, offset_x=0,
  // offset_y=portrait_offset_y
  rotation_configs[0] = {0xE8, height, width, 0, portrait_offset_y};

  // Landscape 90° (normal): width=width, height=height,
  // offset_x=landscape_offset_x, offset_y=0
  rotation_configs[1] = {0x48, width, height, landscape_offset_x, 0};

  // Portrait 180° (rotated): width=height, height=width, offset_x=0,
  // offset_y=portrait_offset_y
  rotation_configs[2] = {0x28, height, width, 0, portrait_offset_y};

  // Landscape 270° (upside down): width=width, height=height,
  // offset_x=landscape_offset_x, offset_y=0
