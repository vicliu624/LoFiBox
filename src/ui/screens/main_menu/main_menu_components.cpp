...
void populate(UiScreen& screen)
{
    ...
    components::add_item(screen, "Music", nullptr, UiIntentKind::OpenSongsAll, PageId::Songs, 0, 0, &Music);
    components::add_item(screen, "Library", nullptr, UiIntentKind::Navigate, PageId::Music, 0, 0, &Library);
    ...
    components::add_item(screen, "Equalizer", nullptr, UiIntentKind::OpenEq, PageId::Eq, 0, 0, &Equalizer);
