...
namespace lofi::ui::screens::playlist_detail::styles
{
void init_once()
{
    list_page::styles::init_once();
}

void apply_content(lv_obj_t* obj)
{
    list_page::styles::apply_content(obj);
}

void apply_list(lv_obj_t* obj)
{
    list_page::styles::apply_list(obj);
}

void apply_list_row(lv_obj_t* obj)
{
    list_page::styles::apply_list_row(obj);
}
