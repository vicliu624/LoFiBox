...
EqLayout create(lv_obj_t* content)
{
    ...
    for (int i = 0; i < kGridLines; ++i) {
        ...
        lv_color_t color = (i == (kGridLines / 2)) ? lv_color_hex(0x3b76ff) : lv_color_hex(0x2a2c30);
        lv_obj_set_style_bg_color(line, color, LV_PART_MAIN);
        lv_obj_set_style_bg_opa(line, LV_OPA_COVER, LV_PART_MAIN);
        lv_obj_set_style_border_width(line, 0, LV_PART_MAIN);
        lv_coord_t y = (grid_h > 1) ? static_cast<lv_coord_t>((grid_h - 1) * i / (kGridLines - 1)) : 0;
    ...
    for (int i = 0; i < 6; ++i) {
        ...
        lv_obj_set_style_bg_color(refs.slider_cols[i], lv_color_hex(0x000000), LV_PART_MAIN);
    ...
    lv_obj_set_style_bg_color(bottom_labels, lv_color_hex(0x000000), LV_PART_MAIN);
