...
static lv_style_t s_slider_edit;
static lv_style_t s_label;
static lv_style_t s_value_label;
static lv_style_t s_value_label_checked;
static lv_style_t s_value_label_edit;
...
void init_once() {
  ...
  lv_style_init(&s_slider_edit);
  lv_style_set_outline_width(&s_slider_edit, 2);
  lv_style_set_outline_color(&s_slider_edit, lv_color_hex(0xffc36a));
  lv_style_set_outline_opa(&s_slider_edit, LV_OPA_COVER);
  lv_style_set_bg_color(&s_slider_edit, lv_color_hex(0xffe2b6));
  lv_style_set_bg_opa(&s_slider_edit, LV_OPA_30);
  ...
  lv_style_init(&s_value_label);
  lv_style_set_text_font(&s_value_label, font);
  lv_style_set_text_color(&s_value_label, lv_color_hex(0xcfd3d7));
  lv_style_set_text_opa(&s_value_label, LV_OPA_COVER);

  lv_style_init(&s_value_label_checked);
  lv_style_set_text_color(&s_value_label_checked, lv_color_hex(0xffffff));

  lv_style_init(&s_value_label_edit);
  lv_style_set_text_color(&s_value_label_edit, lv_color_hex(0xffc36a));
...
void apply_slider_selected(lv_obj_t *obj) {
  ...
  lv_obj_set_style_outline_color(obj, lv_color_hex(0x67c2ff),
                                 LV_PART_MAIN | LV_STATE_CHECKED);
  lv_obj_set_style_outline_opa(obj, LV_OPA_COVER,
                               LV_PART_MAIN | LV_STATE_CHECKED);
  lv_obj_set_style_bg_color(obj, lv_color_hex(0x55b7ff),
                            LV_PART_INDICATOR | LV_STATE_CHECKED);
  lv_obj_set_style_bg_grad_color(obj, lv_color_hex(0x2f75ff),
                                 LV_PART_INDICATOR | LV_STATE_CHECKED);
  lv_obj_set_style_bg_grad_dir(obj, LV_GRAD_DIR_VER,
                               LV_PART_INDICATOR | LV_STATE_CHECKED);
  lv_obj_set_style_bg_opa(obj, LV_OPA_COVER,
                          LV_PART_INDICATOR | LV_STATE_CHECKED);
  lv_obj_set_style_bg_color(obj, lv_color_hex(0x7fd1ff),
                            LV_PART_KNOB | LV_STATE_CHECKED);
  lv_obj_set_style_bg_grad_color(obj, lv_color_hex(0x2f86ff),
                                 LV_PART_KNOB | LV_STATE_CHECKED);
  lv_obj_set_style_bg_grad_dir(obj, LV_GRAD_DIR_VER,
                               LV_PART_KNOB | LV_STATE_CHECKED);
  lv_obj_set_style_bg_opa(obj, LV_OPA_COVER, LV_PART_KNOB | LV_STATE_CHECKED);

  lv_obj_add_style(obj, &s_slider_edit, LV_PART_MAIN | LV_STATE_USER_1);
}
...
void apply_value_label(lv_obj_t *obj) {
  lv_obj_add_style(obj, &s_value_label, LV_PART_MAIN);
  lv_obj_add_style(obj, &s_value_label_checked,
                   LV_PART_MAIN | LV_STATE_CHECKED);
  lv_obj_add_style(obj, &s_value_label_edit, LV_PART_MAIN | LV_STATE_USER_1);
