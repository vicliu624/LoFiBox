...
namespace
{
inline BuildApi make_list_api(void (*init_styles)(), void (*apply_content)(lv_obj_t*), void (*apply_list)(lv_obj_t*),
                              void (*apply_row)(lv_obj_t*), void (*apply_left)(lv_obj_t*),
                              void (*apply_right)(lv_obj_t*), list_page::layout::ListLayout (*create_list)(lv_obj_t*),
...
BuildApi api_for(PageId id)
{
    switch (id) {
    case PageId::Music:
        return make_list_api(screens::music::styles::init_once, screens::music::styles::apply_content,
                             screens::music::styles::apply_list, screens::music::styles::apply_list_row,
                             screens::music::styles::apply_list_label_left,
                             screens::music::styles::apply_list_label_right, screens::music::layout::create_list,
                             screens::music::layout::create_list_row, screens::music::input::attach_row,
                             screens::music::input::focus_first);
    case PageId::Artists:
        return make_list_api(screens::artists::styles::init_once, screens::artists::styles::apply_content,
                             screens::artists::styles::apply_list, screens::artists::styles::apply_list_row,
                             screens::artists::styles::apply_list_label_left,
                             screens::artists::styles::apply_list_label_right, screens::artists::layout::create_list,
                             screens::artists::layout::create_list_row, screens::artists::input::attach_row,
                             screens::artists::input::focus_first);
    case PageId::Albums:
        return make_list_api(screens::albums::styles::init_once, screens::albums::styles::apply_content,
                             screens::albums::styles::apply_list, screens::albums::styles::apply_list_row,
                             screens::albums::styles::apply_list_label_left,
                             screens::albums::styles::apply_list_label_right, screens::albums::layout::create_list,
                             screens::albums::layout::create_list_row, screens::albums::input::attach_row,
                             screens::albums::input::focus_first);
    case PageId::Songs:
        return make_list_api(screens::songs::styles::init_once, screens::songs::styles::apply_content,
                             screens::songs::styles::apply_list, screens::songs::styles::apply_list_row,
                             screens::songs::styles::apply_list_label_left,
                             screens::songs::styles::apply_list_label_right, screens::songs::layout::create_list,
                             screens::songs::layout::create_list_row, screens::songs::input::attach_row,
                             screens::songs::input::focus_first);
    case PageId::Genres:
        return make_list_api(screens::genres::styles::init_once, screens::genres::styles::apply_content,
                             screens::genres::styles::apply_list, screens::genres::styles::apply_list_row,
                             screens::genres::styles::apply_list_label_left,
                             screens::genres::styles::apply_list_label_right, screens::genres::layout::create_list,
                             screens::genres::layout::create_list_row, screens::genres::input::attach_row,
                             screens::genres::input::focus_first);
    case PageId::Composers:
        return make_list_api(screens::composers::styles::init_once, screens::composers::styles::apply_content,
                             screens::composers::styles::apply_list, screens::composers::styles::apply_list_row,
                             screens::composers::styles::apply_list_label_left,
                             screens::composers::styles::apply_list_label_right, screens::composers::layout::create_list,
                             screens::composers::layout::create_list_row, screens::composers::input::attach_row,
                             screens::composers::input::focus_first);
    case PageId::Compilations:
        return make_list_api(screens::compilations::styles::init_once, screens::compilations::styles::apply_content,
                             screens::compilations::styles::apply_list, screens::compilations::styles::apply_list_row,
                             ...
                             screens::compilations::layout::create_list_row, screens::compilations::input::attach_row,
                             screens::compilations::input::focus_first);
    case PageId::Playlists:
        return make_list_api(screens::playlists::styles::init_once, screens::playlists::styles::apply_content,
                             screens::playlists::styles::apply_list, screens::playlists::styles::apply_list_row,
                             screens::playlists::styles::apply_list_label_left,
                             screens::playlists::styles::apply_list_label_right, screens::playlists::layout::create_list,
                             screens::playlists::layout::create_list_row, screens::playlists::input::attach_row,
                             screens::playlists::input::focus_first);
    case PageId::PlaylistDetail:
        return make_list_api(screens::playlist_detail::styles::init_once,
                             ...
                             screens::playlist_detail::input::attach_row, screens::playlist_detail::input::focus_first);
    case PageId::Settings:
        return make_list_api(screens::settings::styles::init_once, screens::settings::styles::apply_content,
                             screens::settings::styles::apply_list, screens::settings::styles::apply_list_row,
    ...
    case PageId::About:
        return make_list_api(screens::about::styles::init_once, screens::about::styles::apply_content,
                             ...
                             screens::about::styles::apply_list_label_left, screens::about::styles::apply_list_label_right,
                             screens::about::layout::create_list, screens::about::layout::create_list_row,
                             screens::about::input::attach_row, screens::about::input::focus_first);
    default:
        return make_list_api(screens::music::styles::init_once, screens::music::styles::apply_content,
                             screens::music::styles::apply_list, screens::music::styles::apply_list_row,
                             screens::music::styles::apply_list_label_left,
...
void build_list_page(UiScreen& screen, const BuildApi& api)
{
    ...
    for (int i = 0; i < visible; ++i) {
        list_page::layout::ListRowLayout row_layout = api.create_row(screen.view.list.list);
