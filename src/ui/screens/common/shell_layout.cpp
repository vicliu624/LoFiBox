...
RootLayout create_root()
{
    ...
    lv_obj_set_flex_align(refs.top_status, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
    ...
    lv_coord_t content_h = lv_display_get_vertical_resolution(nullptr) - topbar_height();
