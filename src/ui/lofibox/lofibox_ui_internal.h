...
struct TimerBag {
  ...
  void reset();
  lv_timer_t *create(TimerDomain domain, lv_timer_cb_t cb, uint32_t period,
                     void *user_data);
...
struct UiScreen {
  ...
  bool delete_prompt_active = false;
  int delete_track_index = -1;
  lv_obj_t *delete_overlay = nullptr;
