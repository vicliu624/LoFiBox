...
typedef struct FLACMetadataBlock_t {
  ...
  uint8_t
      bitsPerSample; // 111 : reserved
                     ...
                     // sample, i.e. one second of 44.1Khz audio will have 44100
                     // samples regardless of the number
  uint64_t
...
typedef struct FLACFrameHeader_t {
  ...
  uint8_t
      blockSizeCode; // 1000-1111 : 256 * (2^(n-8)) samples, i.e.
                     ...
                     // 1110 : get 16 bit sample rate (in tens of Hz) from end
                     // of header
  uint8_t
      sampleRateCode; // 1111 : invalid, to prevent sync-fooling string of 1s
                      ...
                      // channel 1 is the side(difference) channel 1001 :
                      // right/side stereo: channel 0 is the side(difference)
                      // channel, channel 1 is the right channel 1010 : mid/side
                      // stereo: channel 0 is the mid(average) channel, channel
